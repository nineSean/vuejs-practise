...
var app4 = new _vue2.default({
  el: '#app-4',
  data: {
    todos: [{ text: '学习 JavaScript' }, { text: '学习 Vue' }, { text: '整个牛项目' }, { text: 'test' }]
  }
});
...
var app5 = new _vue2.default({
  ...
  methods: {
    ...
    changeToWord: function changeToWord() {
...
var app7 = new _vue2.default({
  el: '#app-7',
  data: {
    groceryList: [{ text: '蔬菜' }, { text: '奶酪' }, { text: '随便其他什么人吃的东西' }]
  }
});

_vue2.default.component('name-item', {
  props: ['todo'],
  template: '<li>{{todo.text}}</li>'
});
var app1 = new _vue2.default({
  el: '#app1',
  data: {
    todos: [{ text: 'neymar' }, { text: 'xavi' }, { text: 'ronaldo' }, { text: 'silva' }, { text: 'messi' }]
  }
});
